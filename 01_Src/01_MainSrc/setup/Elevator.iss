[Setup]
OutputBaseFilename=KiwiElevator V3.0
...
Name: {group}\{cm:UninstallProgram, TestSkin V2.0}; Filename: {uninstallexe}
Name: {userdesktop}\Elevator 3.0; Filename: {app}\ElevatorMgr.exe; Tasks: desktopicon
;Name: {userdesktop}\代理商管理 2.0; Filename: {app}\AgentMgr.exe; Tasks: desktopicon
